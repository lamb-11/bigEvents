  ...
  <el-container>
    ...
    <el-header>
      ...
      <el-menu class="el-menu-demo" mode="horizontal" background-color="#23262e" text-color="#fff" active-text-color="#ffd04b">
        <el-submenu index="1">
          <template slot="title"> <img class="avatar" src="@/assets/images/avatar.jpg" alt=""> 个人中心</template>
    ...
    <el-container>
      ...
      <el-aside width="200px">
        <!-- 个人信息 -->
        <div class="personal">
          <img class="avatar" src="@/assets/images/avatar.jpg" alt="">欢迎 {{nickname||username}}
        </div>
        <!-- 导航栏 -->
