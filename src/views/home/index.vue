  ...
  <div>
    <div class="container-fluid">
      <el-row :gutter="10" class="spannel_list">
        <el-col :sm="6" :xs="12">
          <div class="spannel one">
            10015<span>篇</span>
            <div class="footer">总文章数</div>
          </div>
        </el-col>
        <el-col :sm="6" :xs="12">
          <div class="spannel two">
            123<span>篇</span>
            <div class="footer">日新增文章数
            </div>
          </div>
        </el-col>
        <el-col :sm="6" :xs="12">
          <div class="spannel three">
            35<span>篇</span>
            <div class="footer">评论总数</div>
          </div>
        </el-col>
        <el-col :sm="6" :xs="12">
          <div class="spannel four">
            123<span>篇</span>
            <div class="footer">日新增评论数</div>
          </div>
        </el-col>
      </el-row>
    </div>
